 ...
 * 
 * This class represent the validation for phone number fields only.
 */
public class PhoneNumberValidator extends AbstractValidator {
	
	/**
	 * member variable to represent the phone field object.
	 */
	 ...
	 * Default constructor
	 */
	public PhoneNumberValidator(EditText source) {
		super(true);
		m_Source = source;
	}
	 ...
	 * Default constructor
	 */
	public PhoneNumberValidator(EditText source, String requiredMessage) {
		super(true);
		m_Source = source;
