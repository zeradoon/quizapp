...
public class EventTeamRankingAdapter extends BaseAdapter {
	...
	public EventTeamRankingAdapter(ArrayList<HashMap<String, String>> m_rankinkDataList,
			Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String score_detail = rankingDataList.get(position).get(CommonUtil.T_SCORE)
				+ "점 (" + rankingDataList.get(position).get(CommonUtil.T_PARTICIPATE) + "회)";
