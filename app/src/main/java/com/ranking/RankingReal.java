...
public class RankingReal extends Activity implements OnScrollListener,
	...
	private static final String LOG_TAG = RankingReal.class.getSimpleName();

	private ListView m_listView;
	private TextView m_rankingUserDetail;

	private RankingRealAdapter m_rankingAdapter;
...
//	private boolean isFooter = false;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		m_rankingAdapter = new RankingRealAdapter(m_viewList, m_context);
...
//			isFooter = false;
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		if (m_viewList.get(position - 1).get(CommonUtil.OPEN_YN).equalsIgnoreCase(CommonUtil.FLAG_Y)) {
			Intent intent = new Intent(RankingReal.this, RankingRealDetail.class);
			Bundle b = new Bundle();
