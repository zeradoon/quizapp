...
public class RankingEventBasedIndividualAdapter extends BaseAdapter {
	...
	public RankingEventBasedIndividualAdapter(ArrayList<HashMap<String, String>> m_rankinkDataList,
			Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String score_detail = rankingDataList.get(position).get(CommonUtil.INDIVIDUAL_SCORE)
				+ "점 (" + rankingDataList.get(position).get(CommonUtil.JOIN_CNT) + "회)";
